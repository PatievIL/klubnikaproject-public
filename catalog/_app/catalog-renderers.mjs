      ...
      <div class="home-footer-inner">
        <div class="home-footer-lead">
          <a class="home-footer-logo" href="${resolveHref(ctx, "/")}" aria-label="Klubnika Project">
            <img src="${resolveHref(ctx, "/assets/logo/klubnika-project-logo-green-transparent.webp")}" alt="Klubnika Project" />
          </a>
        </div>
...
function renderSharedFooterStyles(ctx) {
  return `<link rel="stylesheet" href="${resolveHref(ctx, "/assets/css/kp-footer.css?v=20260611a")}" />`;
}
